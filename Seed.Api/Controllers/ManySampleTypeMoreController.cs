...
{
	[Authorize]
    [Route("api/manysampletype/more")]
    public class ManySampleTypeMoreController : Controller
    {

        private readonly IManySampleTypeRepository _rep;
        ...
        public async Task<IActionResult> Get([FromQuery]ManySampleTypeFilter filters)
        {
            ...
            try
            {
				...
				if (filters.FilterBehavior == FilterBehavior.Export)
                {
                    ...
                    var file = export.ExportFile(this.Response, searchResult, "ManySampleType", this._env.RootPath);
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]IEnumerable<ManySampleTypeDtoSpecialized> dtos)
        {
            ...
            {
                return result.ReturnCustomException(ex,"Seed - ManySampleType", dtos, new ErrorMapCustom());
            }

        }

		[HttpPut]
        public async Task<IActionResult> Put([FromBody]IEnumerable<ManySampleTypeDtoSpecialized> dtos)
        {
            var result = new HttpResult<ManySampleTypeDto>(this._logger);
            try
            {
