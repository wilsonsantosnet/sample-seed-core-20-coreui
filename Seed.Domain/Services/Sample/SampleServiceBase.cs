...
namespace Seed.Domain.Services
{
    public class SampleServiceBase : ServiceBase<Sample>
    {
        ...
        {
            this._validationResult  = new SampleAptoParaCadastroValidation(this._rep).Validate(sample);
			this._validationWarning  = new SampleAptoParaCadastroWarning(this._rep).Validate(sample);
        }
